...
async def hourly_shitpost(channelid):
    while True:
        ...
        actions = [
            ...
            f"This is just in, being {random.choice(adjective)} is now legal in {random.choice(country)}!",
            f"This is just in, being {random.choice(adjective)} is now illegal in {random.choice(country)}!",
            ...
            f"This is so sad, can we {random.choice(verb_action)}?",
            ...
            f"A new season of {random.choice(show)} had just been announced!",
            f"{random.choice(person)} just joined the {random.choice(group)}:bangbang::bangbang:",
